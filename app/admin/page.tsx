              ...
              <form onSubmit={handleSubmit} className="grid gap-6">
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    className="mt-2 w-full min-h-[220px] rounded-xl border border-[#d1d5db] bg-white px-4 py-3 text-[#111827] outline-none transition-all focus:border-[#dc2626] resize-y"
                    required
