...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-0 sm:pt-10 md:pt-20 lg:pt-10 overflow-hidden">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pt-3 pb-8 sm:py-10 lg:py-12">
        <div className="rounded-2xl border border-[#e5e7eb] bg-white p-4 sm:p-6">
                ...
                {topWeekPosts.map((post, idx) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-1 text-[13px] lg:text-[14px] text-[#6b7280] font-exo inline-flex items-center gap-1">
              ...
              <div className="rounded-xl border border-[#e5e7eb] bg-[#fafafa] p-3.5 sm:p-4 h-full flex flex-col">
                ...
                {curiosityPost ? (
                  <>
                    ...
                    <p className="mt-2 text-[14px] sm:text-[15px] lg:text-[15px] text-[#4b5563] leading-[1.5] font-exo line-clamp-5">
                  ...
                  <>
                    ...
                    <p className="mt-2 text-[14px] sm:text-[15px] lg:text-[15px] text-[#4b5563] leading-[1.5] font-exo">
          ...
          <div className="mt-5 sm:mt-6 rounded-xl border border-[#e5e7eb] bg-[#0f172a] p-4 sm:p-5 text-white">
            <p className="text-white/70 text-[13px] font-rajdhani uppercase tracking-[0.2em] mb-2">
              Continue explorando
            </p>
